                                ...
                                <tbody>
                                    ...
                                    @foreach($sewa2 as $sewas)
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td width="150px">
                                              <center>
                                                <a type="button" href="{{url(''.$penyewa->id_penyewa.'/'.$penyewa->username.'/pengembalian/'.$sewas->id_sewa.'/form')}}" class="btn btn-warning btn-sm" title="Pengembalian"> <i class="glyphicon glyphicon-arrow-right"></i></a> &nbsp;
