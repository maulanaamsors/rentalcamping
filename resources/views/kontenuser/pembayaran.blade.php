                    ...
                    <div class="panel panel-default" style="width:78%;margin-top:-5px">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%">Upload Bukti </th>
                                    </tr>
                                </thead>
                                <tbody>
                                
                                    @foreach($sewa2 as $sewas)
                                        @if(($sewas->konfirmasi == 'Y' || $sewas->konfirmasi == 'H') && ($sewas->status_sewa == 'disewa' || $sewas->status_sewa == 'booking'))
                                        <tr class="odd gradeX">
                                            ...
                                            <td width="150px">
                                              <center>
                                                <a href="{{url(''.$penyewa->id_penyewa.'/'.$penyewa->username.'/pembayaran/'.$sewas->id_sewa.'/uploadbukti')}}" class="btn btn-success btn-sm" title="Tampil"> <span class="glyphicon glyphicon-send"></span></a> <br>
                                                @if($sewas->bukti_pembayaran == '-')
                                                   <font size="2" color="red"><b>Belum upload<b></font>
                                                @else
                                                   <font size="2" color="green"><b>Sudah upload<b></font>
                                                @endif
                                              </center>
                                            </td>
                                        </tr>
